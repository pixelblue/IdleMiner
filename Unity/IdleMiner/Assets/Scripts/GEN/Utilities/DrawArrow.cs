...
namespace ANS_Core.Utilities
{
    ...
    {
        public static void ForGizmo(Vector3 pos, Vector3 direction, float lengthMultiplier = 1.0f, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f, float arrowPosition = 0.5f)
        {
            ForGizmo(pos, direction, Gizmos.color, lengthMultiplier, arrowHeadLength, arrowHeadAngle, arrowPosition);
        }

        public static void ForGizmo(Vector3 pos, Vector3 direction, Color color, float lengthMultiplier = 1.0f, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f, float arrowPosition = 0.5f)
        {
            Gizmos.color = color;
            Gizmos.DrawRay(pos, direction * lengthMultiplier);
            DrawArrowEnd(true, pos, direction * lengthMultiplier, color, arrowHeadLength, arrowHeadAngle, arrowPosition);
        }
