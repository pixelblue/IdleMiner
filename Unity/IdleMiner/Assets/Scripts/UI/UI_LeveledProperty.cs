...
namespace Idler
{
    public class UI_LeveledProperty : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [SerializeField] private UI_LeveledPropertyInfo infoPopupPrefab;
        ...
        private UI_LeveledPropertyInfo infoPopup;
        ...
        public void Initialize(LeveledProperty leveledProperty, Interactable interactable)
        {
